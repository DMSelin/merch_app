...
frame_list = tk.Frame(mainwindow, width=200, height=300, bg='#E0FFFF')
...
l_routs = tk.Label(frame_list, text='Маршруты').pack()
l_report = tk.Label(frame_list, text='Отчет').pack()
l_positions = tk.Label(frame_list,text='Позиции').pack()
