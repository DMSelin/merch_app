...
def am(adress, comment, count):
    ...
    matrix = [
        (count, f'{name_store}', f'{adress}', f'{positions[0][1]}', '', 1, 579.99, '', f'{comment}'),
        ('', '', '', f'{positions[1][1]}', '', 1, 558.99, ''),
        ('', '', '', f'{positions[6][1]}', 3, 1, 1299.99, ''),
        ('', '', '', f'{positions[7][1]}', 3, 1, 1148.99, ''),
        ('', '', '', f'{positions[8][1]}', 3, 1, 769.99, ''),
        ('', '', '', f'{positions[9][1]}', 3, 1, 689.99, ''),
        ('', '', '', f'{positions[10][1]}', 3, 1, 619.99, ''),
        ('', '', '', f'{positions[11][1]}', 3, 1, 559.99, ''),
