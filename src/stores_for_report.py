...
def pytrchka(adress, comment, count):
    ...
    return [
        (count, f'{name_store}', f'{adress}', f'{positions[3][1]}', '', '', 589.99, '', f'{comment}'),
...
def perek(adress, comment, count):
    ...
    return [
        (count, f'{name_store}', f'{adress}', f'{positions[0][1]}', '', '', 659.99, '', f'{comment}'),
        ('', '', '', f'{positions[2][1]}', '', '', 659.99, ''),
        ('', '', '', f'{positions[1][1]}', '', '', 659.99, ''),
        ('', '', '', f'{positions[3][1]}', '', '', 1299, ''),
        ('', '', '', f'{positions[4][1]}', '', '', 1029, ''),
        ('', '', '', f'{positions[5][1]}', '', '', 739.99, ''),
        ('', '', '', f'{positions[6][1]}', '', '', 799.99, ''),
        ('', '', '', f'{positions[7][1]}', '', '', 689, ''),
        ('', '', '', f'{positions[8][1]}', '', '', 449.99, ''),
        ('', '', '', f'{positions[9][1]}', '', '', 369.99, '')
    ]
...
def magnit(adress, comment, count):
    ...
    return [
        ...
        ('', '', '', f'{positions[1][1]}', '', '', '', ''),
        ('', '', '', f'{positions[2][1]}', '', '', 849.99, '', f'{comment}'),
        ('', '', '', f'{positions[4][1]}', '', '', 759.99, ''),
        ('', '', '', f'{positions[5][1]}', '', '', 699.99, ''),
        ('', '', '', f'{positions[6][1]}', '', '', 575.99, ''),
...
def verniy(adress, comment, count):
    ...
    return [
        (count, f'{name_store}', f'{adress}', f'{positions[0][1]}', '', '', 799.99, '', f'{comment}'),
        ('', '', '', f'{positions[1][1]}', '', '', 799.99, ''),
        ('', '', '', f'{positions[2][1]}', '', '', 689.99, ''),
        ('', '', '', f'{positions[3][1]}', '', '', 399.99, ''),
        ('', '', '', f'{positions[4][1]}', '', '', 509.99, ''),
        ('', '', '', f'{positions[5][1]}', '', '', '', ''),
...
def okei(adress, comment, count):
    ...
    return [
        ...
        ('', '', '', 'Бренди Пре Апельсин 0,5', '', '', 659, ''),
        ('', '', '', 'Бренди Пре Яблоко 0,5', '', '', 659, '')
    ]
...
def vinlab(adress, comment, count):
    ...
    return [
        (count, f'{name_store}', f'{adress}', f'{positions[0][1]}', 1, 1, 739.99, '', f'{comment}'),
        ('', '', '', f'{positions[3][1]}', 3, 1,  359.99, ''),
        ('', '', '', f'{positions[1][1]}', 1, 1,  599.99, ''),
        ('', '', '', f'{positions[2][1]}', 1, 1,  659.99, '')
    ]
